...
"""
    commands_generic_hpgl.py
	generic set of HPGL commands supported by most plotters (modeled on the 7475A command set).
"""

plotterType = "generic_hpgl"
