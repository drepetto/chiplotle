...
def test_relativize_01( ):
   ...
   assert r[0].xy == VectorArray((1, 1))
   assert r[1].xy == VectorArray((1, 0))
...
def test_relativize_02( ):
   ...
   assert len(r) == 1
   assert isinstance(r[0], PR)
   assert r[0].xy == VectorArray([(1, 2), (1, -1)])
...
def test_relativize_03( ):
   ...
   assert isinstance(r[0], PR)
   assert isinstance(r[1], PR)
   assert r[0].xy == VectorArray([(-2, -1)])
   assert r[1].xy == VectorArray([(1, 2), (1, -1)])
...
def test_relativize_04( ):
   ...
   assert r[0].xy == VectorArray((2, 2))
   assert r[1].xy == VectorArray((3, 2))
...
def test_relativize_05( ):
   ...
   assert r[0].xy == VectorArray((2, 1))
   assert r[1].xy == VectorArray((2, 2))
   assert r[2].xy == VectorArray((3, 2))
...
def test_relativize_06( ):
   ...
   assert r[0].xy == VectorArray((1, 2))
   assert r[1].xy == VectorArray((2, 1))
